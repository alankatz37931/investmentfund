...
export async function getQuotes(tickers) {
  ...
  for (const ticker of tickers) {
    ...
    // Pure latestTrade.p — refleja cualquier print fresco de IEX incluyendo after-hours.
    // Trade-off conocido: en momentos sin trades en IEX se queda en el último print
    // (puede diferir del consolidado de NASDAQ/NYSE por algunos dólares). Para precios
    // consolidados reales hace falta SIP (Alpaca pro o Polygon Starter).
    const latestPrice =
