...
export async function getQuotes(tickers) {
  ...
  for (const ticker of tickers) {
    ...
    // Usa el close del bar diario — estable y consistente.
    // No muestra after-hours (la free tier de IEX no lo cubre bien igual).
    // Fallbacks: prevDailyBar (si todavía no hay bar de hoy) y latestTrade.p (último recurso).
    const latestPrice =
