...
export async function getPortfolio(fundId) {
  ...
  // Ganancia del fondo = valor actual − capital aportado por los socios.
  // NO se calcula contra el cost basis de las posiciones actuales, porque
  // ese cost ignora pérdidas (o ganancias) realizadas en operaciones previas.
  // El anchor verdadero es lo que los socios pusieron originalmente.
  const grossPnl = totalMarketValue - totalLpCapital;
